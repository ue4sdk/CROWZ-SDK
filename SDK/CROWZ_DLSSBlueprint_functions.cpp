...
#include "CROWZ_DLSSBlueprint_classes.hpp"
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.SetDLSSSharpness"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.SetDLSSMode"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.QueryDLSSSupport"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.IsDLSSSupported"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.IsDLSSModeSupported"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.GetSupportedDLSSModes"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.GetDLSSSharpness"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.GetDLSSScreenPercentageRange"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.GetDLSSModeInformation"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.GetDLSSMode"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.GetDLSSMinimumDriverVersion"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function DLSSBlueprint.DLSSLibrary.GetDefaultDLSSMode"));
