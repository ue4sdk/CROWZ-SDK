...
#include "CROWZ_WB_HUD_Vehicle_Tank_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_HUD_Vehicle_Tank.WB_HUD_Vehicle_Tank_C
// 0x0040 (0x03D0 - 0x0390)
class UWB_HUD_Vehicle_Tank_C : public UCrowVehicleHUDBase
{
public:
	...
	class UWB_Vehicle_SeatTank_C*                      WB_Vehicle_SeatTank;                                      // 0x03B8(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_HUD_Vehicle_Tank.WB_HUD_Vehicle_Tank_C"));
		return ptr;
	}


	void Tick(const struct FGeometry& MyGeometry, float InDeltaTime);
	void ExecuteUbergraph_WB_HUD_Vehicle_Tank(int EntryPoint);
};
