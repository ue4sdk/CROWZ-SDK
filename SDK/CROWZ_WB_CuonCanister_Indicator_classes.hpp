...
#include "CROWZ_WB_CuonCanister_Indicator_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_CuonCanister_Indicator.WB_CuonCanister_Indicator_C
// 0x0040 (0x0408 - 0x03C8)
class UWB_CuonCanister_Indicator_C : public UCrowWorldIconWidgetBase
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_CuonCanister_Indicator.WB_CuonCanister_Indicator_C"));
		return ptr;
	}
