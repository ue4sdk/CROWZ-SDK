...
#include "CROWZ_WB_HUD_Vehicle_PickUpTruck_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_HUD_Vehicle_PickUpTruck.WB_HUD_Vehicle_PickUpTruck_C
// 0x0030 (0x03C0 - 0x0390)
class UWB_HUD_Vehicle_PickUpTruck_C : public UCrowVehicleHUDBase
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_HUD_Vehicle_PickUpTruck.WB_HUD_Vehicle_PickUpTruck_C"));
		return ptr;
	}


	void Tick(const struct FGeometry& MyGeometry, float InDeltaTime);
	void ExecuteUbergraph_WB_HUD_Vehicle_PickUpTruck(int EntryPoint);
};
