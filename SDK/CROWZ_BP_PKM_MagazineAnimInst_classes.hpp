...
#include "CROWZ_BP_PKM_MagazineAnimInst_structs.hpp"
...
// AnimBlueprintGeneratedClass BP_PKM_MagazineAnimInst.BP_PKM_MagazineAnimInst_C
// 0x01E0 (0x04A0 - 0x02C0)
class UBP_PKM_MagazineAnimInst_C : public UCrowWeaponCharacterAnimInst
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass BP_PKM_MagazineAnimInst.BP_PKM_MagazineAnimInst_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_BP_PKM_MagazineAnimInst(int EntryPoint);
};
