...
#include "CROWZ_WB_C4_Indicator_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_C4_Indicator.WB_C4_Indicator_C
// 0x0018 (0x0390 - 0x0378)
class UWB_C4_Indicator_C : public UCrowIndicatorCompositionC
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_C4_Indicator.WB_C4_Indicator_C"));
		return ptr;
	}
