...
#include "CROWZ_WB_LobbyButton_tab_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_LobbyButton_tab.WB_LobbyButton_Tab_C
// 0x0028 (0x05D0 - 0x05A8)
class UWB_LobbyButton_Tab_C : public UCrowWidgetToggleButton
{
public:
	...
	class UWidgetAnimation*                            Ani_Hover_DeSelect;                                       // 0x05C0(0x0008) (CPF_BlueprintVisible, CPF_BlueprintReadOnly, CPF_ZeroConstructor, CPF_Transient, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_LobbyButton_tab.WB_LobbyButton_Tab_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_WB_LobbyButton_Tab(int EntryPoint);
};
