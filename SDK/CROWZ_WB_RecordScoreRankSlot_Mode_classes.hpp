...
#include "CROWZ_WB_RecordScoreRankSlot_Mode_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_RecordScoreRankSlot_Mode.WB_RecordScoreRankSlot_Mode_C
// 0x0028 (0x03B0 - 0x0388)
class UWB_RecordScoreRankSlot_Mode_C : public UCrowScoreRankSlotModeWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_RecordScoreRankSlot_Mode.WB_RecordScoreRankSlot_Mode_C"));
		return ptr;
	}
