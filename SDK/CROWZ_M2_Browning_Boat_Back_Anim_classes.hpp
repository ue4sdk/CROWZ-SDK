...
#include "CROWZ_M2_Browning_Boat_Back_Anim_structs.hpp"
...
// AnimBlueprintGeneratedClass M2_Browning_Boat_Back_Anim.M2_Browning_Boat_Back_Anim_C
// 0x01F0 (0x04D0 - 0x02E0)
class UM2_Browning_Boat_Back_Anim_C : public UCrowWeaponAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass M2_Browning_Boat_Back_Anim.M2_Browning_Boat_Back_Anim_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_M2_Browning_Boat_Back_Anim(int EntryPoint);
};
