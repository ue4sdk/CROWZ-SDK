...
#include "CROWZ_WB_RecordScoreRankSlot_My_Grade_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_RecordScoreRankSlot_My_Grade.WB_RecordScoreRankSlot_My_Grade_C
// 0x0028 (0x03B0 - 0x0388)
class UWB_RecordScoreRankSlot_My_Grade_C : public UCrowScoreRankSlotGradeWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_RecordScoreRankSlot_My_Grade.WB_RecordScoreRankSlot_My_Grade_C"));
		return ptr;
	}
