...
#include "CROWZ_WB_TabMenu_AppearanceCategory_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_TabMenu_AppearanceCategory.WB_TabMenu_AppearanceCategory_C
// 0x0010 (0x03A8 - 0x0398)
class UWB_TabMenu_AppearanceCategory_C : public UCrowTabOutfitWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_TabMenu_AppearanceCategory.WB_TabMenu_AppearanceCategory_C"));
		return ptr;
	}
