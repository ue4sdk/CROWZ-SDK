...
#include "CROWZ_WB_HUD_Vehicle_RHIB_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_HUD_Vehicle_RHIB.WB_HUD_Vehicle_RHIB_C
// 0x0030 (0x03C0 - 0x0390)
class UWB_HUD_Vehicle_RHIB_C : public UCrowVehicleHUDBase
{
public:
	...
	class UWB_Vehicle_RHIB_C*                          WB_Vehicle_RHIB;                                          // 0x03A0(0x0008) (CPF_BlueprintVisible, CPF_ExportObject, CPF_ZeroConstructor, CPF_InstancedReference, CPF_IsPlainOldData, CPF_RepSkip, CPF_NoDestructor, CPF_PersistentInstance, CPF_HasGetValueTypeHash)
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_HUD_Vehicle_RHIB.WB_HUD_Vehicle_RHIB_C"));
		return ptr;
	}


	void Tick(const struct FGeometry& MyGeometry, float InDeltaTime);
	void ExecuteUbergraph_WB_HUD_Vehicle_RHIB(int EntryPoint);
};
