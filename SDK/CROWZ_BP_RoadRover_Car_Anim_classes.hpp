...
#include "CROWZ_BP_RoadRover_Car_Anim_structs.hpp"
...
// AnimBlueprintGeneratedClass BP_RoadRover_Car_Anim.BP_RoadRover_Car_Anim_C
// 0x04A0 (0x0790 - 0x02F0)
class UBP_RoadRover_Car_Anim_C : public UCrowCarAnimInstance
{
public:
	...
	struct FAnimNode_VehicleWeaponHandler              AnimGraphNode_VehicleWeapon;                              // 0x0488(0x0100)
	struct FAnimNode_CarDashBoardHandler               AnimGraphNode_VehicleCarDashBoard;                        // 0x0588(0x0118)
	struct FAnimNode_CarSteeringHandler                AnimGraphNode_VehicleCarSteering;                         // 0x06A0(0x00F0)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass BP_RoadRover_Car_Anim.BP_RoadRover_Car_Anim_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_BP_RoadRover_Car_Anim(int EntryPoint);
};
