...
#include "CROWZ_BP_SkydivingSkillPawn_structs.hpp"
...
// BlueprintGeneratedClass BP_SkydivingSkillPawn.BP_SkydivingSkillPawn_C
// 0x0030 (0x0AF0 - 0x0AC0)
class ABP_SkydivingSkillPawn_C : public ACrowSkydivingPawn
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("BlueprintGeneratedClass BP_SkydivingSkillPawn.BP_SkydivingSkillPawn_C"));
		return ptr;
	}
