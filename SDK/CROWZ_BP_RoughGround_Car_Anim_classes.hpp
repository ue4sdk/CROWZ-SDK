...
#include "CROWZ_BP_RoughGround_Car_Anim_structs.hpp"
...
// AnimBlueprintGeneratedClass BP_RoughGround_Car_Anim.BP_RoughGround_Car_Anim_C
// 0x03A0 (0x0690 - 0x02F0)
class UBP_RoughGround_Car_Anim_C : public UCrowCarAnimInstance
{
public:
	...
	struct FAnimNode_CarSteeringHandler                AnimGraphNode_VehicleCarSteering;                         // 0x05A0(0x00F0)

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass BP_RoughGround_Car_Anim.BP_RoughGround_Car_Anim_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_BP_RoughGround_Car_Anim(int EntryPoint);
};
