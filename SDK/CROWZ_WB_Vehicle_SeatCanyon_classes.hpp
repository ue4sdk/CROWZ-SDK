...
#include "CROWZ_WB_Vehicle_SeatCanyon_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_Vehicle_SeatCanyon.WB_Vehicle_SeatCanyon_C
// 0x0028 (0x03E0 - 0x03B8)
class UWB_Vehicle_SeatCanyon_C : public UCrowVehicleWidgetSeatPassat
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_Vehicle_SeatCanyon.WB_Vehicle_SeatCanyon_C"));
		return ptr;
	}
