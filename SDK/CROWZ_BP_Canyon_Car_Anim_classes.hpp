...
#include "CROWZ_BP_Canyon_Car_Anim_structs.hpp"
...
// AnimBlueprintGeneratedClass BP_Canyon_Car_Anim.BP_Canyon_Car_Anim_C
// 0x03A0 (0x0690 - 0x02F0)
class UBP_Canyon_Car_Anim_C : public UCrowCarAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass BP_Canyon_Car_Anim.BP_Canyon_Car_Anim_C"));
		return ptr;
	}


	void AnimGraph(struct FPoseLink* AnimGraph);
	void ExecuteUbergraph_BP_Canyon_Car_Anim(int EntryPoint);
};
