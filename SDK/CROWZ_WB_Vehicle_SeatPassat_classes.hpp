...
#include "CROWZ_WB_Vehicle_SeatPassat_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_Vehicle_SeatPassat.WB_Vehicle_SeatPassat_C
// 0x0028 (0x03E0 - 0x03B8)
class UWB_Vehicle_SeatPassat_C : public UCrowVehicleWidgetSeatPassat
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_Vehicle_SeatPassat.WB_Vehicle_SeatPassat_C"));
		return ptr;
	}
