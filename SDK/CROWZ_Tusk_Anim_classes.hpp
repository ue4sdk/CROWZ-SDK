...
#include "CROWZ_Tusk_Anim_structs.hpp"
...
// AnimBlueprintGeneratedClass Tusk_Anim.Tusk_Anim_C
// 0x02F0 (0x05D0 - 0x02E0)
class UTusk_Anim_C : public UCrowWeaponAnimInstance
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("AnimBlueprintGeneratedClass Tusk_Anim.Tusk_Anim_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_Tusk_Anim(int EntryPoint);
};
