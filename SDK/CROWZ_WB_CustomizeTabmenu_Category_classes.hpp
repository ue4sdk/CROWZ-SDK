...
#include "CROWZ_WB_CustomizeTabmenu_Category_structs.hpp"
...
// WidgetBlueprintGeneratedClass WB_CustomizeTabmenu_Category.WB_CustomizeTabmenu_Category_C
// 0x0010 (0x03A8 - 0x0398)
class UWB_CustomizeTabmenu_Category_C : public UCrowTabOutfitWidget
{
public:
	...
	{
		static auto ptr = UObject::FindObject<UClass>(_xor_("WidgetBlueprintGeneratedClass WB_CustomizeTabmenu_Category.WB_CustomizeTabmenu_Category_C"));
		return ptr;
	}
